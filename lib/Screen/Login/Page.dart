...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SafeArea(child:
            CCon(color: CustomColors.white, padding: EdgeInsets.all(20), child:
              CCol(main: MainAxisAlignment.center, cross: CrossAxisAlignment.center, children: [
                Image.asset('assets/login/login.png'),
                SizedBox(height: 41),
                Text('풀렉스에서 다른 거지 친구들과 함께\n재미있게 절약해봐요!', style: CustomTextStyles.Body2(color: CustomColors.black), textAlign: TextAlign.center),
                SizedBox(height: 41),
                Button(type: ButtonTypes.elevated, color: CustomColors.kakaoYellow, child:
                    Container(height: 56, child:
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                        Image.asset('assets/login/kakao.png', width: 24, height: 24,),
                        Text('카카오로 3초만에 로그인', style: CustomTextStyles.Body2(color: CustomColors.black)),
                        SizedBox(width: 24)
                      ]),
                    ),
                ...
                SizedBox(height: 20),
                Button(type: ButtonTypes.elevated, color: CustomColors.black, child:
                  Container(height: 56, child:
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                      Image.asset('assets/login/apple.png', width: 24, height: 24,),
                      Text('Apple ID로 로그인', style: CustomTextStyles.Body2()),
                      SizedBox(width: 24)
                    ]),
                  ),
