...
class BattleParticipant extends GetView {
  ...
  Widget build(BuildContext context) {
    BattleController battle = BattleController();
      ...
      children: [
        Expanded(
            child: ListView.separated(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                     ...
                                     */
                                      SizedBox(width: 10),
                                      Text('${battle.battleList[idx].budget}만원',
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: NetworkImage(
                                                  '${battle.battleList[idx].imageUrl}'),
                                              fit: BoxFit.cover),
                                        ),
                                      ),
                                    ],
                ...
                itemCount: battle.battleList.length))
      ],
    );
  }
}
