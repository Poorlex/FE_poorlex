          ...
          Row(
            children: [
              Expanded(
                  child: TextButton(
                      onPressed: () =>
                          Navigator.push(context, NoticeDetailModal()),
                      ...
                      child: GameBox(
                          ...
                          child: Row(children: [
                            SizedBox(
                                ...
                                width: 22,
                                child: Image.asset(
                                    'assets/battle_page/icon_notice.png')),
                            SizedBox(
                              width: 6,
                            ),
                            Text('공지',
                ...
                child: Column(children: [
                  ...
                  ChatItem(
                      ...
                      child: GameBox(
                          color: CColors.gray20,
                          padding: EdgeInsets.fromLTRB(0, 30, 0, 30),
                          child: VoteResultItem(
                              name: '버블티', money: 5000, isUp: true)),
                      time: TimeItem(
                        time: DateTime.now().microsecondsSinceEpoch,
                        align: MainAxisAlignment.start,
                      )),
                  ...
                  ChatItem(
                      ...
                      child: GameBox(
                          padding: EdgeInsets.fromLTRB(0, 30, 0, 30),
                          child: VoteResultItem(
                              name: '버블티', money: 5000, isUp: false)),
                      time: TimeItem(
                        time: DateTime.now().microsecondsSinceEpoch,
                        align: MainAxisAlignment.end,
                      )),
                  ...
                  ChatItem(
                      ...
                      child: GameBox(
                        ...
                        child: OpinionItem(
                            isAgree: false,
                            comment: Text('아픈건 어쩔수 없지만 기왕이면 소금양치하시죠',
                  ...
                  child: Row(
                    ...
                    children: [
                      SizedBox(
                          width: 21,
                          height: 22,
                          child: Image.asset('assets/icons/vote.png')),
                      SizedBox(width: 8),
                      Text('투표하기',
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    width: 140,
                                    height: 140,
                                    child: Image.asset(isAgree
                                        ? 'assets/icons/agree.png'
                                        : 'assets/icons/disagree.png'),
                                  )
                                ],
                              ),
                            ),
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: 100,
                  height: 100,
                  child: Image.asset(isUp
                      ? 'assets/battle_page/thumb_up_big.png'
                      : 'assets/battle_page/thumb_down_big.png'),
                ),
                SizedBox(height: 20),
                Text(name, style: CTextStyles.Title3(color: CColors.black)),
                SizedBox(height: 10),
                Text(money.toString() + '원',
                    style: CTextStyles.Title3(color: CColors.black)),
              ],
            ),
          )
      ...
      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        Container(
          ...
          child: Row(
            ...
            children: [
              CIcon(
                  icon: 'thumb-down', color: '#666666', width: 36, height: 36),
              SizedBox(width: 20),
              Expanded(
                  child:
                      CustomBar(current: 2, total: 5, primary: CColors.gray30))
            ],
          ),
        ),
      ])
          ...
          Container(
              ...
              child: TextButton(
                  onPressed: () => Navigator.push(
                      context, CommentModal(id: id, isAgree: false)),
                  style: TextButton.styleFrom(
                    padding: EdgeInsets.zero,
                  ),
                  child: Stack(children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          SizedBox(
                              ...
                              height: 26,
                              child: Image.asset(
                                  'assets/battle_page/thumb_up.png')),
                          SizedBox(width: 2),
                      ...
                      child: Row(
                        ...
                        children: [
                          SizedBox(
                            ...
                            height: 26,
                            child: Image.asset(
                                'assets/battle_page/thumb_down.png'),
                          ),
                          SizedBox(
                            width: 2,
                          ),
