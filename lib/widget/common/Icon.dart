...
class CIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (icon == 'close') {
      ...
      ''', width: width.toDouble(), height: height.toDouble());
    } else if (icon == 'close-box') {
      return SvgPicture.string('''
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path opacity="0.8" d="M0 0H16V16H0V0Z" fill="black"/>
        <rect x="11.7773" y="4" width="1" height="11" transform="rotate(45 11.7773 4)" fill="#CCCCCC"/>
        <rect x="12.4844" y="11.7783" width="1" height="11" transform="rotate(135 12.4844 11.7783)" fill="#CCCCCC"/>
      </svg>
      ''', width: width.toDouble(), height: height.toDouble());
      ...
      return SvgPicture.string('''
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd" d="M6.22227 4.49934C6.22227 5.87968 5.06153 6.99867 3.62968 6.99867C2.19783 6.99867 1.03709 5.87968 1.03709 4.49934C1.03709 3.11899 2.19783 2 3.62968 2C5.06153 2 6.22227 3.11899 6.22227 4.49934ZM0 12C0 9.79086 1.62504 8 3.62963 8C5.15698 8 6.46399 9.03965 6.99975 10.5118C7.53551 9.03965 8.84251 8 10.3699 8C12.3745 8 13.9995 9.79086 13.9995 12H7.25926H6.74023H0ZM10.2781 6.99867C11.71 6.99867 12.8707 5.87968 12.8707 4.49934C12.8707 3.11899 11.71 2 10.2781 2C8.84629 2 7.68555 3.11899 7.68555 4.49934C7.68555 5.87968 8.84629 6.99867 10.2781 6.99867Z" fill="white"/>
        </svg>
      ''', width: width.toDouble(), height: height.toDouble());
    } else if (icon == 'chat') {
      return SvgPicture.string('''
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M8 12.5081H7H2H1V11.5081V3.5835V2.5835H2H14H15V3.5835V11.5081V12.5081H14H10.9931L9 14.8334L8 16.0001V14.4635V13.5081V12.5081ZM8 11.5081H2V3.5835H14V11.5081H10.9931H10.5332L10.2339 11.8573L9 13.2968V12.5081V11.5081H8ZM5.08335 6.66675H3.91669V7.83341H5.08335V6.66675ZM7.41669 6.66675H8.58335V7.83341H7.41669V6.66675ZM12.0834 6.66675H10.9167V7.83341H12.0834V6.66675Z" fill="white"/>
        </svg>
      ''', width: width.toDouble(), height: height.toDouble());
    } else if (icon == 'add_friend') {
      return SvgPicture.string('''
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M22.4759 3.48617V1H20.819V3.48617H18.333V5.11117H20.819V7.5H22.4759V5.11117H24.833V3.48617H22.4759ZM6.64688 21L3.99063 23H15.0094L12.3531 21H6.64688ZM12.6875 20H6.3125L2.32812 23L1 24H2.6625H16.3375H18L16.6719 23L12.6875 20ZM3.16667 8.58301L3.16667 7.66634L3.16667 7.58301H3.25H4.16667H4.25V7.49967V6.58301V6.49967H4.33333H5.25H5.33333V6.41634V5.49967V5.41634H5.41667H6.33333H6.41667V5.33301V4.41634V4.33301H7.41667H7.5H8.58333H9.66667H10.75H11.8333H11.9167H12.9167V4.41634V5.33301V5.41634H13H13.9167H14V5.49967V6.41634V6.49967H14.0833H15H15.0833V6.58301V7.49967V7.58301H15.1667H16.0833H16.1667V7.66634V8.58301V8.66634L16.25 8.66634L17.1667 8.66634L17.25 8.66634V8.74967V9.66634V9.74967H17.3333H18.25H18.3333V10.7497V10.833V11.9163V11.9997V12.9997H18.25H17.3333H17.25V13.083V13.9997V14.083H17.1667H16.25H16.1667V14.1663V15.083V15.1663H16.0833H15.1667H15.0833V15.2497V16.1663V16.2497H15H14.0833H14V16.333V17.2497V17.333H13.9167H13H12.9167V17.4163V18.333V18.4163H11.9167H11.8333H10.75H9.66667H8.58333H7.5H7.41667H6.41667V18.333V17.4163V17.333H6.33333H5.41667H5.33333V17.2497V16.333V16.2497H5.25H4.33333H4.25V16.1663V15.2497V15.1663H4.16667H3.25H3.16667V15.083V14.1663V14.083H3.08333H2.16667H2.08333V13.9997V13.083V12.9997H2H1.08333H1V11.9997V11.9163V10.833V10.7497V9.74967H1.08333H2H2.08333L2.08333 9.66634L2.08333 8.74967V8.66634L2.16667 8.66634L3.08333 8.66634L3.16667 8.66634V8.58301ZM4.16667 8.66634V8.58301H4.25H5.25V7.58301V7.49967H5.33333H6.33333V6.49967V6.41634H6.41667H7.41667V5.41634V5.33301H7.5H8.58333H9.66667H10.75H11.8333H11.9167V5.41634V6.41634H12.9167H13V6.49967V7.49967H14H14.0833V7.58301V8.58301H15.0833H15.1667V8.66634V9.66634H16.1667H16.25V9.74967V10.7497H17.25H17.3333V10.833V11.9163V11.9997H17.25H16.25V12.9997V13.083H16.1667H15.1667V14.083V14.1663H15.0833H14.0833V15.1663V15.2497H14H13V16.2497V16.333H12.9167H11.9167V17.333V17.4163H11.8333H10.75H9.66667H8.58333H7.5H7.41667V17.333V16.333H6.41667H6.33333V16.2497V15.2497H5.33333H5.25V15.1663V14.1663H4.25H4.16667V14.083V13.083H3.16667H3.08333V12.9997V11.9997H2.08333H2V11.9163V10.833V10.7497H2.08333H3.08333V9.74967V9.66634H3.16667H4.16667V8.66634ZM6.41667 9.74967H8.04167V11.3747H6.41667V9.74967ZM13.4583 9.74967H11.8333V11.3747H13.4583V9.74967Z" fill="white"/>
        </svg>
      ''', width: width.toDouble(), height: height.toDouble());
    } else if (icon == 'more') {
      return SvgPicture.string('''
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M3.79102 11.9165H6.49935V14.6248H3.79102V11.9165ZM11.7002 11.9165H14.4085V14.6248H11.7002V11.9165ZM22.3156 11.9165H19.6073V14.6248H22.3156V11.9165Z" fill="white"/>
        </svg>
      ''', width: width.toDouble(), height: height.toDouble());
    } else if (icon == 'check') {
      return SvgPicture.string('''
        <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M1 5L4.75 8.125L11 1.25" stroke="white"/>
        </svg>
      ''', width: width.toDouble(), height: height.toDouble());
    }
    return Container();
