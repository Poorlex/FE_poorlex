...
class _GoalListState extends State<GoalList> {
  void onClickOption(int id, BuildContext context) {
    void selectOption(String mode, int id) {
      print(mode);
      print(id);
    }
...
class GoalListItem extends StatelessWidget {
  final void Function(int, BuildContext) onClickOption;
  ...
  Widget build(BuildContext context) {
    return Container(
        decoration: BoxDecoration(
            border:
                Border(bottom: BorderSide(color: CColors.gray10, width: 1))),
                  ...
                  child: Column(
                    ...
                    Row(
                      ...
                      <path d="M7 4.00024V7.50024H10.5" stroke="black"/>
                          ...
                          Text('~ 2023.11.09',
                              style:
                                  CTextStyles.Caption1(color: CColors.gray41)),
                        ])
                  ])),
              TextButton(
...
/// [MEMO] Rogan: 파일 정리 과정에서 selectOption없음 확인 필요.
class OptionButtonModal extends StatelessWidget {
  final void Function(String, int) selectOption;
  OptionButtonModal({
    super.key,
    ...
    return SizedBox(
        ...
        child: SafeArea(
          ...
          Expanded(
            ...
            child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [Text('수정', style: CTextStyles.Headline())]),
          )),
          Expanded(
              child: TextButton(
            onPressed: () => print(1111),
