              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 27),
                    Text('투표 내용', style: CTextStyles.Body3(color: CColors.gray40)),
                    SizedBox(height: 17),
                    TextField(
                    ...
                    SizedBox(height: 27),
                    Text('투표 시간', style: CTextStyles.Body3(color: CColors.gray40)),
                    SizedBox(height: 17),
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          OutlinedButton(
                            onPressed: () {},
                            child: Text('5분', style: CTextStyles.Body3(color: CColors.gray41)),
                            style: OutlinedButton.styleFrom(
                              side: BorderSide(color: CColors.gray41, width: 1.0),
                          ...
                          OutlinedButton(
                            onPressed: () {},
                            child: Text('10분', style: CTextStyles.Body3(color: CColors.gray41)),
                            style: OutlinedButton.styleFrom(
                              side: BorderSide(color: CColors.gray41, width: 1.0),
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                            ),
                          ...
                          OutlinedButton(
                            onPressed: () {},
                            child: Text('20분', style: CTextStyles.Body3(color: CColors.gray41)),
                            style: OutlinedButton.styleFrom(
                              side: BorderSide(color: CColors.gray41, width: 1.0),
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                            ),
                          ...
                          OutlinedButton(
                            onPressed: () {},
                            child: Text('30분', style: CTextStyles.Body3(color: CColors.gray41)),
                            style: OutlinedButton.styleFrom(
                              side: BorderSide(color: CColors.gray41, width: 1.0),
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                            ),
                          ...
                          OutlinedButton(
                            onPressed: () {},
                            child: Text('1시간', style: CTextStyles.Body3(color: CColors.gray41)),
                            style: OutlinedButton.styleFrom(
                              side: BorderSide(color: CColors.gray41, width: 1.0),
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                            ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('투표생성', style: CTextStyles.Title3(color: CColors.black))
                      ],
                    ),
                  )
                ],
