      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            _bulletPointText(text: "예산 달성 성공 시 획득 가능합니다."),
            _bulletPointText(text: "배틀 등수에 따라 차등 분배 됩니다."),
            _bulletPointText(text: "지출 입력 시 획득 가능합니다."),
            _bulletPointText(text: "목표 설정 시 획득 가능합니다."),
          ],
        ),
      ),
    );
