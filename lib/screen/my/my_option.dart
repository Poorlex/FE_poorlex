                          ...
                          child: Row(children: [
                            ...
                            Obx(() => Switch(
                                  ...
                                  onChanged: (bool value) =>
                                      user.updateUserAlarm(
                                          'EXPENDITURE_REQUEST', value),
                                  value: user.alarmAllows.value
                      ...
                      Container(
                          ...
                          child: Row(children: [
                            ...
                            Obx(() => Switch(
                                  ...
                                  inactiveThumbColor: CColors.gray10,
                                  inactiveTrackColor: CColors.gray50,
                                  onChanged: (bool value) => user
                                      .updateUserAlarm('BATTLE_STATUS', value),
                                  value: user.alarmAllows.value
                                          .allowBattleStatusAlarm ??
                                      false,
                                ))
                          ])),
                      Container(
                          ...
                          child: Row(children: [
                            ...
                            Obx(() => Switch(
                                  ...
                                  inactiveTrackColor: CColors.gray50,
                                  onChanged: (bool value) => user
                                      .updateUserAlarm('BATTLE_CHAT', value),
                                  value: user.alarmAllows.value
                                          .allowBattleChatAlarm ??
                                      false,
                                ))
                          ])),
                      Container(
                          ...
                          child: Row(children: [
                            ...
                            Obx(() => Switch(
                                  ...
                                  inactiveTrackColor: CColors.gray50,
                                  onChanged: (bool value) =>
                                      user.updateUserAlarm('FRIEND', value),
                                  value:
                                      user.alarmAllows.value.allowFriendAlarm ??
                                          false,
                                ))
                          ])),
                      Container(
                          ...
                          child: Row(children: [
                            ...
                            Obx(() => Switch(
                                  ...
                                  inactiveTrackColor: CColors.gray50,
                                  onChanged: (bool value) => user
                                      .updateUserAlarm('BATTLE_INVITE', value),
                                  value: user.alarmAllows.value
                                          .allowBattleInvitationAlarm ??
                                      false,
                                ))
                          ]))
                    ])))));
